...
Through sex-stratified Reporting Odds Ratio analysis, we identified 183,544 sex-differential drug–adverse event signals, of which 49,026 are strong (>2.7× ratio, ≥10 reports per sex), with 58.5% showing female bias. DistMult knowledge graph embeddings (200d, 100 epochs) achieved MRR 0.048 and AMRI 0.9807 on link prediction, demonstrating meaningful structural learning across the heterogeneous graph.
