...
Results: From 14.5 million reports, we identified 49,026 strong sex-differential drug–adverse event signals (|ln(ROR ratio)| > 1.0, ≥10 reports per sex), with 58.5% showing female bias. Knowledge graph embedding achieved AMRI of 0.981, placing correct triples in the top 1.9% of candidates. Embedding-based clustering of 29,201 drugs into 20 groups revealed distinct sex-differential safety landscapes with female bias ratios ranging from 0.33 to 1.00. Target-level analysis identified 429 gene targets with sex-biased safety profiles, including novel findings: HDAC1/2/3/6 (exclusively female-biased), ESR1 (counterintuitively male-biased, −0.80), and ITGA2B/ITGB3 (exclusively female-biased). Signal validation against 15 literature benchmarks achieved 67% confirmation rate.
