...
story.append(Paragraph(
    ...
    "(126,575 entities, 6 relations) on NVIDIA DGX Spark GB10. Drug embeddings were clustered (K=20) and bridged to "
...
# Embedding results
story.append(Paragraph(
    "<b>Link Prediction.</b> DistMult achieved MRR 0.048, Hits@10 8.85%, and AMRI 0.981, ranking correct "
...
# Validation
story.append(Paragraph(
    "<b>Validation.</b> Against 15 literature benchmarks: 9/15 drugs found (60%), 6/9 confirmed or weakly confirmed "
    "(67%). Confirmed: atorvastatin (female myalgia, 3.4×), digoxin (female toxicity), aspirin (male GI bleeding).",
    body_style
))
