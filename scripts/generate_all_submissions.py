...
s.append(Paragraph(
    ...
    body))
s.append(Paragraph(
    "Knowledge graph embedding using DistMult (200d, 100 epochs) achieved AMRI of 0.981, confirming the graph captures "
...
s.append(Paragraph(
    ...
    "(2) DistMult embedding achieving AMRI 0.981 on a 126K-entity domain-specific graph; (3) a comparative RotatE "
...
s.append(Paragraph(
    ...
    "researchers studying sex-based differences in pharmacology, toxicology, and precision medicine. The 67% validation "
...
s.append(Paragraph(
    ...
    "429 gene targets with sex-differential drug safety profiles. Knowledge graph embeddings (DistMult, AMRI 0.981) "
    "demonstrate the feasibility of computational sex-aware safety prediction.",
    body))
s.append(Paragraph(
    "Signal validation against 15 literature-documented benchmarks achieved 67% confirmation rate, demonstrating "
...
abstracts = {
    "ASHG2026_abstract.txt": (
        ...
        "DistMult KG embeddings (200d, AMRI 0.981) confirm meaningful pharmacogenomic structure. These targets provide hypotheses for sex-aware "
    ...
    "NeurIPS2026_abstract.txt": (
        ...
        "We train DistMult embeddings (200 dimensions, 100 epochs) achieving Adjusted Mean Rank Index (AMRI) of 0.981, placing correct triples "
        ...
        "male-biased estrogen receptor drug safety. Signal validation against 15 literature benchmarks achieves 67% confirmation. SexDiffKG is "
