...
def build_pdf():
    ...
    abstract_text = (
        ...
        "0.981, demonstrating meaningful link prediction capability that places correct triples "
        ...
        "literature-documented sex-differential drug safety benchmarks achieved 67% inclusive "
        "confirmation rate (9/15 drugs found, 6/9 confirmed or weakly confirmed). SexDiffKG "
    ...
    contribs = [
        ...
        "Embeds the full graph using DistMult (200 dimensions) to enable sex-aware link prediction, with AMRI of 0.981 indicating correct triple ranking in the top 1.9% of candidates",
        "Reveals 429 gene targets with measurable sex-differential drug safety profiles through embedding-based analysis",
        "Validates findings against 15 literature-documented benchmarks, achieving 67% inclusive confirmation rate",
    ...
    lp_rows = [
        ...
        ["AMRI", "0.981", "Top 1.9% of 13,466 candidates"],
    ...
    story.append(Paragraph(
        "The AMRI of 0.981 indicates the model consistently ranks correct triples near the top "
    ...
    story.append(Paragraph("<b>Table 6.</b> Validation against 15 literature benchmarks.", caption_style))
    story.append(make_table(val_headers, val_rows, [1.3*inch, 0.7*inch, 3.5*inch]))
    story.append(Spacer(1, 6))

    story.append(Paragraph(
        "Hit rate: 9/15 drugs found (60%), of which 6/9 confirmed or weakly confirmed (67% "
    ...
    lims = [
        ...
        "RotatE dramatically underperformed DistMult (AMRI 0.003 vs 0.981), likely due to insufficient epochs and symmetric relation structure.",
