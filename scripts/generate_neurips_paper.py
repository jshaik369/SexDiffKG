...
S.append(Paragraph(
    ...
    "embeddings (200 dimensions, 100 epochs) achieving an Adjusted Mean Rank Index (AMRI) of 0.981, placing correct "
...
S.append(Paragraph("<b>Contributions.</b> (1) A heterogeneous KG integrating 14.5M FAERS reports with 5 biomedical "
    ...
    "sex-differential signals; (3) DistMult embeddings achieving AMRI 0.981 with comparative RotatE evaluation; "
    "(4) Discovery of 429 gene targets with sex-biased safety profiles; (5) Validation against 15 literature benchmarks.",
    body))
...
S.append(Paragraph(
    "DistMult achieves AMRI of 0.981, indicating correct triples are ranked in the top 1.9% of 13,466 candidates. "
...
S.append(Paragraph(
    "Against 15 literature-documented sex-differential drug safety benchmarks: 9/15 drugs found in KG (60%), "
    "6/9 confirmed or weakly confirmed (67% inclusive). Confirmed signals: atorvastatin (female myalgia, 3.4×), "
...
S.append(Paragraph(
    "<b>Practical implications for KG embedding.</b> The stark DistMult vs RotatE contrast (AMRI 0.981 vs 0.003) "
...
S.append(Paragraph(
    ...
    "analysis capability. The AMRI of 0.981 indicates strong embedding quality despite the graph's heterogeneity.",
    body))
