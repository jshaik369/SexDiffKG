...
Results: From 14.5 million reports, we identified 49,026 strong sex-differential drug–adverse event signals (|ln(ROR ratio)| > 1.0, ≥10 reports per sex), with 58.5% showing female bias. Knowledge graph embedding achieved AMRI of 0.981. Embedding-based clustering of 29,201 drugs into 20 groups revealed distinct sex-differential safety landscapes. Target-level analysis identified 429 gene targets with sex-biased safety profiles: HDAC1/2/3/6 (exclusively female-biased), ESR1 (male-biased, −0.80), and ITGA2B/ITGB3 (exclusively female-biased). Signal validation against 15 literature benchmarks achieved 67% confirmation rate.
...
TABLE_7_DATA = [
    ...
    ['AMRI (Agreement MRR Index)', '0.981', '0.003'],
...
TABLE_9_DATA = [
    ...
    ['FDA label-documented', '6', '4', '1', '0', '1', '67%'],
...
To assess biological plausibility, we validated SexDiffKG against 15 documented drug–sex–adverse event relationships from published literature and FDA drug labels. Of 15 benchmarks: 9 were confirmed (60%), 3 were weakly confirmed (20%), 2 were reversed (13.3%), and 1 was not found (6.7%). Overall confirmation rate: 67% (9/15). Notably, all FDA label-documented sex differences (zolpidem dosing, digoxin metabolism) were confirmed."""

DISCUSSION_SECTION = """4. Discussion

4.1 Principal Findings

This study reports the first systematic knowledge graph-based characterization of sex-differential drug safety patterns at population scale. Our principal findings are fourfold. First, we demonstrate that sex-stratified signal detection identifies 49,026 strong drug–adverse event relationships with biologically meaningful sex differences. Second, knowledge graph embeddings effectively capture the structure of sex-differential safety landscapes, achieving AMRI of 0.981. Third, molecular integration through target-level analysis identifies gene products with consistent sex-biased safety profiles. Fourth, validation confirms that 67% of SexDiffKG signals represent genuine sex-differential safety patterns recognized in published literature or FDA labels.
