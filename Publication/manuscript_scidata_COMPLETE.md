...
All models used an 80/20 train/test split with random_state=42 for reproducibility. The adjusted mean rank index (AMRI) exceeding 0.99 for all completed models indicates that predictions are substantially better than random ranking across the full entity set.
...
| RotatE v4.1 | v4.1 | 200 complex | 200 | 0.0941 | 5.82% | 15.65% | 0.9651 | CPU | Complete |

All models used an 80/20 train/test split with random_state=42, PyKEEN 1.11.1 framework. ComplEx v4 achieves a 5.2-fold MRR improvement over DistMult v3 baseline. AMRI > 0.99 indicates correct triples ranked in the top 0.5% of candidates.
