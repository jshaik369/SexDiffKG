...
We trained three knowledge graph embedding models using PyKEEN 1.11.1 [19]. ComplEx was trained on 1,822,562 triples (excluding 289 sex_differential_expression edges); DistMult v4.1 and RotatE v4.1 were trained on the full 1,822,851 triples (all 6 relation types):
