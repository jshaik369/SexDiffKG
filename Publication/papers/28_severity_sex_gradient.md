...
Each MedDRA preferred term was matched against a curated keyword lexicon of 347 terms distributed across seven tiers. The lexicon was developed iteratively from ICH E2A serious outcome definitions, expanded using the WHO-ART critical terms list and CTCAE grade 4-5 terms. Ambiguous terms (e.g., "pneumonia") were assigned to the tier reflecting the most common clinical severity in a pharmacovigilance context.

To assess inter-rater reliability, a random sample of 200 MedDRA preferred terms was independently classified by two clinical pharmacologists using the tier definitions without access to the keyword lexicon, with agreement assessed by weighted kappa. Full classification of 5,069 MedDRA terms with sex-differential signals was then performed algorithmically.
...
**Alternative severity assignments for ambiguous terms.** For 42 MedDRA terms with potentially ambiguous severity (e.g., "pneumonia"), we reassigned one tier higher and lower to determine whether reclassification materially affected the gradient.
...
**Cardiovascular drugs** showed the widest within-class variability. ACE inhibitors exhibited strong female bias for angioedema (immune-mediated severe AE) but near-parity for hypotension (pharmacodynamic mild AE), underscoring that the severity-sex gradient operates at the level of individual drug-AE pairs, not drug classes per se.
...
Two specific pharmacokinetic pathways illustrate this amplification. CYP3A4 activity is approximately 20--30% higher in women than men on average [22], driven by growth hormone secretory patterns and estrogen induction. For narrow therapeutic index drugs metabolized by CYP3A4---including immunosuppressants, statins, and calcium channel blockers---this enzymatic sex difference can shift women's effective exposure across toxicity thresholds, where the steep dose-toxicity curve amplifies the probability of severe organ damage. Similarly, women have approximately 10% lower glomerular filtration rates after body surface area adjustment [13], producing chronically higher trough levels of renally cleared drugs (e.g., lithium, methotrexate, digoxin). This modest overexposure may be clinically silent for mild AEs but sufficient to push women across thresholds for renal failure (80.7%F) or methotrexate-induced pancytopenia.
...
The X chromosome encodes more immune-related genes than any other chromosome, including TLR7, FOXP3, and CD40L [15]. Although X-inactivation silences one copy in females, approximately 15--23% of X-linked genes escape inactivation, potentially providing women with higher expression of key immune effectors. This dosage effect is hypothesized to underlie the 78% female predominance of autoimmune diseases [16] and may similarly drive the female predominance of immune-mediated drug toxicity. Estrogen further amplifies immune responses through ERa signaling in T cells, B cells, macrophages, and dendritic cells [14], enhancing B cell survival, Th1 pro-inflammatory responses, and interferon-stimulated gene expression. These effects create a baseline state of heightened immune surveillance in women that, when combined with drug-induced immune activation, produces disproportionately severe immune-mediated toxicity.
...
Additional limitations relate to the severity classification itself: the keyword-based assignment cannot capture the clinical nuance of individual case reports, and MedDRA preferred terms vary in specificity. The observational nature of FAERS precludes definitive causal inference; unmeasured confounders---including age, weight, renal function, and comedication burden---could contribute to the observed patterns. Finally, the sex variable in FAERS is recorded as a binary (male/female) without capturing hormonal status or menopausal stage, which may modulate the severity-sex gradient through estrogen-dependent immune and CYP pathways.
