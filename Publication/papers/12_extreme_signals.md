...
The final analytic dataset comprised 14,536,008 deduplicated reports (8,744,397 female [60.2%]; 5,791,611 male [39.8%]).

### 2.2 Signal Detection Framework

For each drug-AE pair with at least 10 reports per sex, we computed:
...
From 14,536,008 deduplicated FAERS reports, we identified 96,281 sex-differential signals meeting the minimum threshold of 10 reports per sex, spanning 2,178 unique drugs and 5,069 unique adverse events.
