...
We extracted all individual case safety reports (ICSRs) from the FDA Adverse Event Reporting System (FAERS) quarterly data files spanning 2004 Q1 through 2025 Q3, comprising 87 quarterly releases. After deduplication by FDA case identifier and removal of reports with missing sex designation, the analytic dataset comprised 14,536,008 reports. The sex distribution was 60.2% female (n = 8,750,685) and 39.8% male (n = 5,785,323), consistent with the well-documented female predominance in spontaneous ADR reporting (Zucker & Prendergast, 2020).
